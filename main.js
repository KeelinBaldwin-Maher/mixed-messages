...
// I kind of get it, i'm getting the math for this from: https://javascript.info/bezier-curve
...
function animate(duration) {
    ...
    requestAnimationFrame(function animate(time) {
        ...
        let {pointX, pointY} = bezierPath(cubicBezier(0, 0.35, 0.53, 1, timeLine));

        flowerMotion(pointX, pointY);
